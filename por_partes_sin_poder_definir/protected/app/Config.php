...
//Por esto es que mas adelante se notara la utilizacion de la constante BASE_URL.
	...
	define('BASE_URL', 'http://localhost/por_partes_sin_poder_definir/'); // en desarrollo Guarda la direccion BASE de nuestro sistema.
	...
	define("DB_NAME", "11"); // Nombre de la base de datos.
