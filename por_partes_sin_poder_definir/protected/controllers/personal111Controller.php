<?php 
	class personalController extends Controller{
		...
		function registrar(){
				// validaciones $this->_view->setJs(array('js/registrar personal'));
	...
	//enviamos ala funcion Insert en el modelo de personas el arreglo 
			$this->_personal->registrar($persona);	
						 // metodo  arreglo
			$this->_view->redirect('personal/listado');
			             //        carpeta/ vista
				}else{ 
					// se muestra la ventana si no es via post.
					$this->_view->render('insert', 'persons');
				}
			}
